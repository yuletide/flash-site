...
if(isset($_GET['icon'])) {
    ...
    $l['css'] = '';
    $l['php'] = '';
...
$sitename = 'Snatchr';            // Site's title
$date = 'M-d-y';                    // Date format
$ignore = array(                    // Ignore these
    '.',
    '..',
    '.htaccess',
    'icon.php',
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-gb" lang="en-gb">
    <head profile="http://gmpg.org/xfn/11">
        <title><?php echo $current_dir_name==''?'Directory list':$current_dir_name?></title>
        <link rel="icon" href="image/favicon.ico" type="image/x-icon" />
        <link rel="stylesheet" type="text/css" href="include/stylesheet_home.css" media="all" />
        ...
        <meta name="copyright" content="Copyright (c) Christopher Robinson 2005 - <?php echo date('Y'); ?>" />
        ...
        <script type="text/javascript">_uacct = "UA-534469-1"; urchinTracker();</script>
